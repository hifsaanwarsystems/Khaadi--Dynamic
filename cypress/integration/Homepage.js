...
Secondscrollbanners()
    {
        ...
        cy.get(getvalue.imgLink).eq(0).should('be.visible').should('have.css','display','block').and('have.css','height','342px').and('have.css','overflow','hidden').and('have.css','position','relative')
        ...
        cy.get(getvalue.imgLink).eq(1).should('be.visible').should('have.css','display','block').and('have.css','height','342px').and('have.css','overflow','hidden').and('have.css','position','relative')
        //.should('have.descendants','video')
        ...
        cy.get(getvalue.imgLink).eq(2).should('be.visible').should('have.css','display','block').and('have.css','height','342px').and('have.css','overflow','hidden').and('have.css','position','relative')
       ...
       // cy.go('back')
        ...
        cy.get(getvalue.imgLink).eq(3).should('be.visible').should('have.css','display','block').and('have.css','height','342px').and('have.css','overflow','hidden').and('have.css','position','relative')//.should('have.descendants','video')
